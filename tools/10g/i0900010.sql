Rem
Rem $Header: i0900010.sql 14-nov-2005.09:57:39 rburns Exp $
Rem
Rem i0900010.sql
Rem
...
/
UPDATE sys.lob$ SET retention = 0 WHERE retention IS NULL;
/
UPDATE sys.lob$ SET freepools = 65535 WHERE freepools IS NULL;
/
ALTER TABLE sys.lob$
MODIFY
(
