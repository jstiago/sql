...
Rem
Rem  MODIFIED
Rem     kamble     04/24/06 - Backport kamble_bug-4711857 from main 
Rem     jgalanes   04/13/06 - Backport jgalanes_bug-4656020 from main 
Rem     geadon     03/27/06 - Backport geadon_bug-4375555 from main 
Rem     dgagne     01/26/06 - add replace for apos in exu10asc view for 
Rem                           columns with apos in them 
Rem     dgagne     03/16/06 - Backport dgagne_bug-4758949 from main 
...
CREATE OR REPLACE VIEW sys.exppiotmap
        ...
        SELECT t.obj#, t.dataobj#, t.ts#, t.file#, t.block#, 
               ...
               DECODE(po.spare1, 1, 'KEEP', 2, 'RECYCLE', 'DEFAULT'), 
