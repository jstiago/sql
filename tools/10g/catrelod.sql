Rem
Rem $Header: catrelod.sql 28-oct-2005.06:24:46 rburns Exp $
Rem
Rem catrelod.sql
Rem
...
Rem =======================================================================
Rem Confirm that the previous release was a 10.2.0.x release
Rem =======================================================================
...
BEGIN
  ...
  IF p_version IS NOT NULL AND SUBSTR(p_version,1,6) != '10.2.0' THEN
     RAISE_APPLICATION_ERROR (-20000,
        'Upgrade from version ' || p_version || 
        ' cannot be downgraded to version 10.2.0.');
  END IF;
END;
/
