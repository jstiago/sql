Rem
Rem $Header: catupgrd.sql 14-nov-2005.09:57:37 rburns Exp $
Rem
Rem catupgrd.sql
Rem
...
BEGIN
  ...
  ELSIF substr(p_version,1,5) = '9.0.1' THEN
     RETURN '0900010';
  ELSIF substr(p_version,1,5) = '9.2.0' AND
     substr(p_version,1,7) NOT IN ('9.2.0.1', '9.2.0.2', '9.2.0.3') THEN
     RETURN '0902000';
  ...
  ELSIF substr(p_version,1,6) = '10.2.0' THEN -- current version
     ...
     -- rerun upgrade of previous release 
        ...
        ELSIF substr(p_prv_version,1,6) = '10.1.0' THEN
           RETURN '1001000';
        ELSIF substr(p_prv_version,1,6) = '10.2.0' OR 
