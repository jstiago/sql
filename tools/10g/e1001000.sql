Rem
Rem $Header: e1001000.sql 10-jul-2006.14:08:33 mxu Exp $
Rem
Rem e1001000.sql
Rem
...
Rem        STAGE 1: downgrade the components, check component status;
Rem        STAGE 2: perform actions always required
Rem        STAGE 3: downgrade base data dictionary objects from 10.2 to 10.1.0
...
Rem    tcruanes    10/20/05 - support for fix control 
Rem    rburns      09/21/05 - add component downgrades 
Rem    zqiu        08/29/05 - Drop OLAP sparsity advisor types 
Rem    adagarwa    04/25/05 - null out l/sql stack cols in wrh$_active_sess_history
Rem    jinwu       01/13/06 - Fix LRG 1967967 (drop dbms_reco_script_lib) 
...
Rem =========================================================================
Rem BEGIN STAGE 1: downgrade installed components to previous release
Rem =========================================================================

Rem For next release, remove the component downgrades and required actions
Rem and then uncomment the following:
Rem @@e1002000
...
Rem =========================================================================
Rem END STAGE 1: downgrade installed components to previous release
Rem =========================================================================

Rem =========================================================================
Rem BEGIN STAGE 2: downgrade actions always performed
Rem =========================================================================
...
Rem =========================================================================
Rem END STAGE 2: downgrade actions always performed
Rem =========================================================================

Rem =========================================================================
Rem BEGIN STAGE 3: downgrade dictionary from 10.2 to 10.1
Rem =========================================================================
...
Rem =========================================================================
Rem END STAGE 3: downgrade dictionary from 10.2 to 10.1
Rem =========================================================================
...
Rem =========================================================================
Rem Conditionally drop objects that cause invalidation of packages needed
Rem in downgrades to prior releases (that will be run subsequently).
Rem Add unconditional drops to lower downgrade scripts (e.g., e0902000.sql).
Rem =========================================================================
